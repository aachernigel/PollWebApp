...
<div class="pollMessage">
    <div class="innerDiv">
        <form action="ChangePasswordServlet" method="post">
            ...
            <input type="text" id="prevPasswordChangePassword" name="prevPasswordChangePassword"><br/>
            <label for="newPasswordChangePassword" id="newPasswordChangePasswordLabel">New password:</label><br/>
            <input type="text" id="newPasswordChangePassword" name="newPasswordChangePassword"><br/>
